...
from app.domain.exceptions import TaskNotFound, TodoNotFound
from app.interfaces.dependencies import (
    get_current_user, get_todo_use_cases, get_task_use_cases,
    require_project_access,
)
from app.interfaces.schemas import TodoCreate, TodoResponse, TodoUpdate
...
def _task_project_id(task_id: int, task_uc) -> int | None:
    ...
    from app.interfaces.routers.tasks import _group_project_id
    try:
