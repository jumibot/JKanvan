...
from app.application.project_use_cases import ProjectUseCases
from app.application.tag_use_cases import TagUseCases
from app.application.task_use_cases import TaskUseCases
from app.application.todo_use_cases import TodoUseCases
from app.application.user_use_cases import UserUseCases
from app.domain.entities import User
from app.domain.exceptions import ProjectNotFound, UserNotInProject
from app.infrastructure.jwt_handler import decode_access_token
from app.infrastructure.repositories.group_repository import SQLiteGroupRepository
from app.infrastructure.repositories.priority_repository import SQLitePriorityRepository
from app.infrastructure.repositories.project_repository import SQLiteProjectRepository
from app.infrastructure.repositories.tag_repository import SQLiteTagRepository
from app.infrastructure.repositories.task_repository import SQLiteTaskRepository
from app.infrastructure.repositories.todo_repository import SQLiteTodoRepository
...
def get_priority_use_cases():
    from app.application.priority_use_cases import PriorityUseCases
