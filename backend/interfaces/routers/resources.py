...
from backend.application.resource_use_cases import ResourceUseCases
from backend.domain.exceptions import EmailAlreadyExists, ResourceNotFound
from backend.interfaces.dependencies import get_resource_use_cases
from backend.interfaces.schemas import ResourceCreate, ResourceResponse, ResourceUpdate
